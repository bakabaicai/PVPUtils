...
final class WebGUIModules {
    private static final List<Category> CATEGORIES = List.of(
            ...
            new Category("Tool", "工具", List.of(
                    ...
                    module("Arrow Trajectory Prediction", "箭矢轨迹预测", "Show the predicted arrow trajectory and impact point while drawing a bow.", "拉弓时显示箭矢的预测轨迹和落点", "arrowTrajectoryPredict",
                            check("arrowTrajectoryPredictBlock", "Block Impact Prediction", "落点方块预测"),
                            check("arrowTrajectoryPredictEntity", "Entity Impact Prediction", "落点实体预测"),
                            check("arrowTrajectoryPredictEntityMovement", "Entity Movement Prediction", "实体运动预测", "arrowTrajectoryPredictEntity"),
                            check("arrowTrajectoryPredictOtherPlayers", "Other Player Arrow Warning", "其他玩家箭矢预警")),
