...
public class ResetManager {
    public static void resetAll() {
        ...
        Config.pingHud = false;
        Config.pingHudStyle = Config.HudStyle.LITE;
        Config.pingHudBackground = true;
        Config.pingHudX = 130f;
        Config.pingHudY = 40f;
        Config.pingHudScale = 1.0f;
        Config.tpsHud = false;
        Config.tpsHudStyle = Config.HudStyle.LITE;
        Config.tpsHudBackground = true;
        Config.tpsHudX = 130f;
        Config.tpsHudY = 68f;
        Config.tpsHudScale = 1.0f;
        Config.clockHud = false;
        Config.clockHudStyle = Config.HudStyle.LITE;
        Config.clockHudBackground = true;
        Config.clockHudX = 130f;
        Config.clockHudY = 140f;
        Config.clockHudScale = 1.0f;
